        ...
        <div className="Timeline" ref={timelineRef}>
            ...
            <defs>
                <linearGradient id="Gradient1">
                    <stop offset="0%" stopColor="rgb(245, 204, 160)"/>
                    <stop offset="25%" stopColor="rgb(228, 143, 69)"/>
                    <stop offset="75%" stopColor="rgb(153, 77, 28)"/>
                    <stop offset="100%" stopColor="rgb(107, 36, 12)"/>
                </linearGradient>
            </defs>
            <motion.circle
